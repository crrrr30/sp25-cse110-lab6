...
export class RecipeCard extends HTMLElement {
     ...
     *
     * @param {RecipeCardData} data - The data to pass into the <recipe-card> must be of the
     *                              following format:
     *                              {
     *                                "imgSrc": "string",
     *                                "imgAlt": "string",
    ...
    set data(data) {
        ...
        article.innerHTML = getCardInnerHtml(data);
    }
}
...
/**
 * @param {RecipeCardData} data 
 * @returns {string}
 */
const getCardInnerHtml = data => `
<img src="${data.imgSrc}"
    alt="${data.imgAlt}"
>
<p class="title">
...
<div class="rating">
    ...
    <img
        src="assets/images/icons/${data.rating}-star.svg"
        alt="${data.rating} star${data.rating == 1 ? "" : "s"}"
    >
